...
<body>
  ...
  <li style="float:right"><a class="na" href="log.html">Log In</a></li>
  <li style="float:right"><a class="na" href="Registration.html">Sign Up</a></li>
</ul>
    ...
    <div class="limiter">
		<div class="container-login100">
            ...
            <?php
             ...
             $stEnrNo = "UWU/CST/17/025";
            $sql = "SELECT mobile,initial,fullName FROM register WHERE stEnrNo='$stEnrNo'";
            $result = $connection->query($sql);

            if ($result->num_rows > 0) {
                // output data of each row
                while($row = $result->fetch_assoc()) {
                    echo "		<span class="txt1 p-b-11">ENR. Number</span>
              					<div class="wrap-input100 validate-input m-b-36"><span>".$stEnrNo. "</span>	</div>

                                <div class="summary">
                					<span class="txt1 p-b-11">01. Student's Full Name</span>
