...
<table>
  ...
  <?php
   ...
   $sql = "SELECT hostel_no,hostelName,gender,no_of_Students,address  from hostels";
...
?>
      ...
      <!--<form action="addhostelCode.php" method="POST">
      <input type="hidden" name="id" value="<?php echo $row["hostel_no"];?>"> 
      <td>
      ...
      <td>-->
       <td>
        <a class="btn btn-danger" href="addhostelCode.php?delete=<?php echo $row["hostel_no"];?>">DELETE </a>
       </td>
 ...
 <div class="hot-container">
  <p>
   ...
   <button type="submit" class="btn btn-primary"  name="id" value="<?php echo $row["hostel_no"];?>" data-toggle="modal"  data-target="#roomModal">Add rooms</button> 
...
?>
 ...
 <div class="hot-container">
  <p>
    <button class="btn" data-toggle="modal" data-target="#exampleModal">Add Hostel</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ADD HOSTELS</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?php require_once "addhostelCode.php";?>
    <div class="testbox">
      <form action="addhostelCode.php" method="POST">
        ...
        <div class="item">
          <p> Total Students</p>
          <input type="Numberr" name="totalnum" required />
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="testbox">
      <form action="addhostelCode.php" method="POST">
        ...
        <div class="item">
          <p> Add room Number with bed Number </p>
